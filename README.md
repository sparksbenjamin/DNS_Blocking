...
Optional DNSTwist-based lookalike and brand-impersonation lists for higher-sensitivity blocking, plus a separate active impersonation review workflow.
...
- `hardening/active_impersonation/` for scored live-lookalike review reports generated by a separate daily workflow
